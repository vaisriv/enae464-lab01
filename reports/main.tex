...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        Room Temperature, $T$ & $25~^{\circ}\mathrm{C}$            & $\pm 0.5~^{\circ}\mathrm{C}$ \\
        Room Pressure, $P$   & $1009.0~\mathrm{hPa}$ & --          \\ \hline
    \end{tabular}
\end{table}
...
where:
\begin{itemize}
    \item \(P\) is the absolute pressure (in SI units: Pa)
    \item \(T\) is the absolute temperature (in Kelvin)
    \item \(R\) is the specific gas constant for dry air, \(R = 287.05~\mathrm{J/(kg\cdot K)}\)
\end{itemize}

Given measurements:
\begin{align*}
    P      &= 1009.0~\mathrm{hPa} = 100900~\mathrm{Pa} \\
    T      &= 25~^{\circ}\mathrm{C} = 25 + 273.15 = 298.15~\mathrm{K} \\
    R      &= 287.05~\mathrm{J/(kg\cdot K)}
\end{align*}

\[
    \rho = \frac{100900~\mathrm{Pa}}{287.05~\mathrm{J/(kg\cdot K)} \times 298.15~\mathrm{K}}
\]
